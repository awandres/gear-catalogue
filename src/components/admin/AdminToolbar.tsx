...
export function AdminToolbar() {
  ...
  return (
    <div className={`fixed top-24 right-6 bg-gray-900 text-white rounded-lg shadow-2xl transition-all duration-300 ${isCollapsed ? 'w-14' : 'w-64'} ${isShaking ? 'animate-shake' : ''}`} style={{ zIndex: 100000 }}>
